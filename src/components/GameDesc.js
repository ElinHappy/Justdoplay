...
export default class GameDesc extends Component {
    ...
    <header style=""><h2 class="Wa2Xpu5vfbxVCjRv2Gv_">Shooting Games</h2></header>
    ...
    <h3 class="sc-16uwngq-0 fPImMN">What are the best free Shooting Games online?</h3>
    ...
    <h4 class="sc-16uwngq-0 fPImMN">What are the most popular Shooting Games for the mobile phone or tablet?</h4>
    <ol class="sc-16uwngq-1 dquIfs">
        <li><a href="/en/g/venge-io">Venge.io</a></li>
        <li><a href="/en/g/narrow-one">Narrow.One</a></li>
        <li><a href="/en/g/stick-merge">Stick Merge</a></li>
